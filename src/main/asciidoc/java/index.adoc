...
----
compile 'io.vertx:vertx-service-proxy:3.5.0-SNAPSHOT'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:3.5.0-SNAPSHOT'
----
...
[source]
----
compile "io.vertx:vertx-service-proxy:3.5.0-SNAPSHOT:processor"
----
...
To withdraw your service, use the `link:../../apidocs/io/vertx/serviceproxy/ServiceProxyFactory.html#unregister-io.vertx.core.eventbus.MessageConsumer-[unregister]`
method:
