...
----
compile 'io.vertx:vertx-service-proxy:3.4.2-SNAPSHOT'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:3.4.2-SNAPSHOT'
----
...
[source]
----
compile "io.vertx:vertx-service-proxy:3.4.2-SNAPSHOT:processor"
----
