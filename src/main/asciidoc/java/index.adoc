...
----
compile 'io.vertx:vertx-service-proxy:3.8.1-SNAPSHOT'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:3.8.1-SNAPSHOT'
----
...
[source]
----
compile "io.vertx:vertx-codegen:3.8.1-SNAPSHOT:processor"
compile "io.vertx:vertx-service-proxy:3.8.1-SNAPSHOT"
----
