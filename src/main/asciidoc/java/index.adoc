...
----
compile 'io.vertx:vertx-service-proxy:3.5.1-SNAPSHOT'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:3.5.1-SNAPSHOT'
----
...
[source]
----
compile "io.vertx:vertx-service-proxy:3.5.1-SNAPSHOT:processor"
----
