...
----
compile 'io.vertx:vertx-service-proxy:4.0.0-milestone1'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:4.0.0-milestone1'
----
* Gradle >= 5 (in your `build.gradle` file):

[source,groovy,subs="+attributes"]
----
annotationProcessor 'io.vertx:vertx-codegen:4.0.0-milestone1:processor'
annotationProcessor 'io.vertx:vertx-service-proxy:4.0.0-milestone1'
----
...
[source]
----
compile "io.vertx:vertx-codegen:4.0.0-milestone1:processor"
compile "io.vertx:vertx-service-proxy:4.0.0-milestone1"
----
