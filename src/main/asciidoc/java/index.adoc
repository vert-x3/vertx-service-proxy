...
----
compile 'io.vertx:vertx-service-proxy:3.5.0.Beta1'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:3.5.0.Beta1'
----
...
[source]
----
compile "io.vertx:vertx-service-proxy:3.5.0.Beta1:processor"
----
