...
*/
public class ServiceNotUsingListTypeVertxEBProxy implements ServiceNotUsingListType {

  private Vertx _vertx;
  private String _address;

  public ServiceNotUsingListTypeVertxEBProxy(Vertx vertx, String address) {
    this._vertx = vertx;
